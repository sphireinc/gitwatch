...
it with `asciinema play docs/demo.cast`. The README image is an animated preview
of the recorded application; the cast is the authoritative capture of the real
application.
