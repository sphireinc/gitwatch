# Task 60: Implement safe branch mutations

## Objective
Support create, switch, rename, set/unset upstream, delete merged branch, and force-delete only with explicit warning. Prevent deleting checked-out/worktree-bound branches. Clearly explain uncommitted-change blockers.
