# Task 48: Create full-screen commit composer

## Objective
Build a polished commit workspace with staged-change summary, diff preview, subject/body editor, character guidance, optional metadata toggles, validation, keyboard/mouse controls, and visible commit readiness state. Do not execute commits yet.
