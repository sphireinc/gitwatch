...
**Status:** In progress — stash list view with selection, filtering, empty-state rendering, asynchronous Bubble Tea loading, and selected-stash patch preview are implemented; create/apply/pop/drop actions and conflict-state UI remain.
