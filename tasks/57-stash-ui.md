...
**Status:** In progress — stash list view with selection, filtering, empty-state rendering, and asynchronous Bubble Tea loading are implemented; create/apply/pop/drop actions and conflict-state UI remain.
