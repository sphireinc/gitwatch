...
**Status:** Complete — direct argv execution, `--` path boundaries, restore confirmation, control-byte sanitization, private debug logs, and shell-metacharacter/control-byte regression tests are implemented.
