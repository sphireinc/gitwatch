...
Progress: Added explicit branch push and opt-in force-with-lease command primitives with validated remote/ref arguments. Ref movement preview, set-upstream/tag workflows, strong confirmation UI, and refresh remain.
