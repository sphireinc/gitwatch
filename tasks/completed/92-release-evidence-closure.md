...
**Status:** Complete — recorded exact-candidate automated Go 1.27/lint/test/race/vet/security/performance/secret evidence, added a reviewable release decision record, reconciled the beta matrix and release notes, and explicitly blocked publication pending native platform/operator evidence and final artifact approval.
