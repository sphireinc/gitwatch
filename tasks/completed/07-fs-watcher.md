...
Read-only metadata `CHMOD` artifacts emitted by kqueue are filtered to prevent
watcher/status feedback loops while real metadata writes and worktree mode
changes continue to trigger refreshes.
