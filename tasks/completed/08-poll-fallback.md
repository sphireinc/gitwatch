...
**Status:** Complete — explicit `auto|fs|poll` mode parsing/selection, bounded
polling that excludes Git object payloads and object-directory metadata,
low-frequency filesystem reconciliation, visible setup/runtime fallback, active
mode rendering, and authoritative refresh integration are implemented and
tested across native CI platforms.
