...
**Status:** In progress — source version is prepared as `1.0.0-dev`, release notes and five-target checksummed archives are prepared, launch smoke checks pass, missing-Git behavior is classified and tested, unusual filenames/renames are covered against real Git, and partial macOS keyboard/diff evidence is recorded; final cross-platform/manual acceptance, signed tagging, and publication remain.
