# Task 47: Build commit composition domain model

## Objective
Model staged files, unstaged files, selected hunks, commit message subject/body, amend mode, signoff, author override, signing status, hooks, and validation. Keep draft commit text in memory while navigating views and define when it is cleared.
