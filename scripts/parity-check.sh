...
go test ./internal/integration -run 'Test(RepositoryWorkbenchScenario|MultiRepositoryRefreshTransitionScenario|BatchFetchFiftyDisposableRepositoriesIsBoundedAndFailureIsolated|AdvancedHistoryAndComparisonParityScenario|BisectParityScenarioSurvivesFreshLoaderAndReset|CherryPickConflictResumeParityScenario|MergeConflictResumeParityScenario|RebaseConflictResumeParityScenario|RevertConflictResumeParityScenario)$' -count=1
